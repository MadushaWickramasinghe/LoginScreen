...
import 'package:loginui/config/colors.dart';
import 'package:loginui/screen/homeScreen.dart';
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: Container(
                ...
                color: Color(0xff655e5e).withOpacity(.85),
                child: Column(
                  ...
                  children: [
                    RichText(
                      text: TextSpan(
                          ...
                          children: [
                            TextSpan(
                              text: isSignupScreen ? " Appname " : " Back,",
                              style: TextStyle(
                                fontSize: 25,
